/* TopJUI前端框架 v2.2.8 http://www.topjui.com */
...
function openDialogAndloadDataByParentGrid(a) {
    ...
    if (!a.dialog.beforeOpenCheckUrl || beforeOpenCheck(replaceUrlParamValueByBrace(a.dialog.beforeOpenCheckUrl, d))) {
        ...
        var e = $("#" + a.dialog.id),
            f = topJUI.config.appendRefererParam ? appendSourceUrlParam(a.dialog.href) : a.dialog.href, g = f;
...
function openDialogAndloadDataByUrl(a) {
    ...
    if ($("#" + a.dialog.id).iDialog("createDialog", a.dialog), !a.dialog.beforeOpenCheckUrl || beforeOpenCheck(replaceUrlParamValueByBrace(a.dialog.beforeOpenCheckUrl, c[0]))) {
        var d = $("#" + a.dialog.id),
            e = topJUI.config.appendRefererParam ? appendSourceUrlParam(a.dialog.href) : a.dialog.href;
        if (a.dialog.href.indexOf("{") != -1) {
...
function doAjaxHandler(a) {
    ...
    if (a = $.extend(!0, b, a), topJUI.config.appendRefererParam && (a.url = appendSourceUrlParam(a.url)), a.url.indexOf("{parent") != -1) {
...
function requestHandler(a) {
    if (topJUI.config.appendRefererParam && (a.url = appendSourceUrlParam(a.url)), "object" == typeof a.grid) {
...
function deleteHandler(a) {
    ...
    b = $.extend(c, b), topJUI.config.appendRefererParam && (b.url = appendSourceUrlParam(b.url));
    ...
    if ("object" == typeof b.grid) {
                ...
                choose: function (a) {
                    ...
                    a.preview(function (a, b, e) {
                        var f = bytesToSize(b.size),
                            g = {uuid: a, fileName: b.name, fileSize: f, progress: 0, fileState: "等待上传"};
        ...
        var k = function () {
            ...
            for (var d = 0; d < b.length; d++) {
                ...
                delete i[b[d].uuid], upfileGrid.datagrid("deleteRow", e)
            }
...
var defaultConfig = {
    ...
    config: {
        ...
        statusCode: {success: 200, failure: 300}
    },
    language: {
        message: {
...
!function (a) {
    a.easyui = {
        ...
        parse: function (b) {
            for (var c = [], d = 0; d < a.parser.plugins.length; d++) {
                var e = a.parser.plugins[d], f = a('[data-toggle="topjui-' + e + '"]', b);
                e = "i" + e.substr(0, 1).toUpperCase() + e.substr(1), f.length && (f[e] ? f.each(function () {
        ...
        parseValue: function (b, c, d, e) {
            ...
            return "%" == g ? (f = parseFloat(f.substr(0, f.length - 1)), f = b.toLowerCase().indexOf("width") >= 0 ? Math.floor((d.width() - e) * f / 100) : Math.floor((d.height() - e) * f / 100)) : f = parseInt(f) || void 0, f
        },
        ...
        function e(b, c, d, e) {
            var f = a(b), g = c, h = g.substr(0, 1).toUpperCase() + g.substr(1),
                i = a.parser.parseValue("min" + h, e["min" + h], d),
                j = a.parser.parseValue("max" + h, e["max" + h], d), k = a.parser.parseValue(g, e[g], d),
    ...
    function d(b) {
        f && clearTimeout(f), e(b, "mouseup"), (a.fn.draggable.isDragging || a.fn.resizable.isResizing) && b.preventDefault()
    }

    function e(b, c, d) {
        var e = new a.Event(c);
        e.pageX = b.changedTouches[0].pageX, e.pageY = b.changedTouches[0].pageY, e.which = d || 1, a(b.target).trigger(e)
    }
...
}(jQuery), topJUI = $.extend(!0, defaultConfig, myConfig), function (a) {
    function b(b) {
    ...
    function expandPanel(a, b) {
        function c() {
            f.show(),
                d.collapsed = !1, d.onExpand.call(a), loadData(a), doLayout(a)
        }
    ...
    function wrapTabs(a) {
        ...
        b.children("div").each(function () {
            ...
            var c = $.extend({}, $.parser.parseOptions(this), {
                disabled: !!$(this).attr("disabled") || void 0, selected: !!$(this).attr("selected") || void 0
            });
            createTab(a, c, $(this))
    ...
    a.fn.textbox = function (d, f) {
        ...
        options: function (b) {
            ...
            return b.each(function () {
                var b = (a.data(this, "textbox").options, a(this).textbox("getValue"));
                a(this).textbox("initValue", c), b != c && a(this).closest("form").trigger("_change", [this])
            })
        }, getText: function (a) {
    ...
    function createStyleSheet(a) {
        ...
        return h || (h = $.data(g[0], "ss", {cache: {}, dirty: []})), {
            add: function (a) {
                for (var b = ['<style type="text/css" easyui="true">'], c = 0; c < a.length; c++) h.cache[a[c][0]] = {width: a[c][1]};
                var d = 0;
    ...
    function setBodySize(a) {
        var b = $.data(a, "datagrid"), c = b.options, d = b.dc, e = b.panel, f = e.width(), g = e.height(), h = d.view,
            i = d.view1, j = d.view2, k = i.children("div.datagrid-header"), l = j.children("div.datagrid-header"),
            m = k.find("table"), n = l.find("table");
        h.width(f);
        var o = k.children("div.datagrid-header-inner").show();
        i.width(o.find("table").width()), c.showHeader || o.hide(), j.width(f - i._outerWidth()), i.children()._outerWidth(i.width()), j.children()._outerWidth(j.width());
        var p = k.add(l).add(m).add(n);
        p.css("height", "");
        var q = Math.max(m.height(), n.height());
        p._outerHeight(q), h.children(".datagrid-empty").css("top", q + "px"), d.body1.add(d.body2).children("table.datagrid-btable-frozen").css({
            position: "absolute",
    ...
    function fixRowHeight(a, b, c) {
        function d(a, b) {
            for (var c = 0; c < b.length; c++) {
                var d = $(a[c]), e = $(b[c]);
                d.css("height", "auto"), e.css("height", "auto");
                var f = Math.max(d.height(), e.height(), i) + 1;
        ...
        var f = ($.data(a, "datagrid").data.rows, $.data(a, "datagrid").options), g = $.data(a, "datagrid").dc,
            h = $('<tr class="datagrid-row" style="position:absolute;left:-999999px"></tr>').appendTo("body"),
            i = h._outerHeight() - 1;
        if (h.remove(), !g.body1.is(":empty") && (!f.nowrap || f.autoRowHeight || c)) if (void 0 != b) {
            var j = f.finder.getTr(a, b, "body", 1), k = f.finder.getTr(a, b, "body", 2);
            d(j, k)
        } else {
            var j = f.finder.getTr(a, 0, "allbody", 1), k = f.finder.getTr(a, 0, "allbody", 2);
            if (d(j, k), f.showFooter) {
                var j = f.finder.getTr(a, 0, "allfooter", 1), k = f.finder.getTr(a, 0, "allfooter", 2);
                d(j, k)
            }
        }
        if (setBodySize(a), "auto" == f.height) {
            var l = g.body1.parent(), m = g.body2, n = e(m), o = n.height;
            n.width > m.width() && (o += 18), o -= parseInt(m.css("marginTop")) || 0, l.height(o), m.height(o), g.view.height(g.view2.height())
        }
    ...
    function freezeRow(a, b) {
        ...
        f.body2.children("table.datagrid-btable-frozen").length || f.body1.add(f.body2).prepend('<table class="datagrid-btable datagrid-btable-frozen" cellspacing="0" cellpadding="0"></table>'), c(!0), c(!1), setBodySize(a)
    }
    ...
    function wrapGrid(target, rownumbers) {
        ...
        var cc = getColumns(), view = panel.children("div.datagrid-view"), view1 = view.children("div.datagrid-view1"),
        ...
        function createColumnHeader(a, b, c) {
            if (b) {
                ...
                for (var i = $('<table class="datagrid-htable" border="0" cellspacing="0" cellpadding="0"><tbody></tbody></table>').appendTo(a), j = 0; j < b.length; j++) for (var k = $('<tr class="datagrid-header-row"></tr>').appendTo($("tbody", i)), l = b[j], m = 0; m < l.length; m++) {
                    var n = l[m], o = "";
                    n.rowspan && (o += 'rowspan="' + n.rowspan + '" '), n.colspan && (o += 'colspan="' + n.colspan + '" ', n.id || (n.id = ["datagrid-td-group" + DATAGRID_SERNO, j, m].join("-"))), n.id && (o += 'id="' + n.id + '"');
                    ...
                    if (n.checkbox) p.attr("field", n.field), $('<div class="datagrid-header-check"></div>').html('<input type="checkbox"/>').appendTo(p); else if (n.field) {
                        p.attr("field", n.field), p.append('<div class="datagrid-cell"><span></span><span class="datagrid-sort-icon"></span></div>'), p.find("span:first").html(n.title);
                        var q = p.find("div.datagrid-cell"), r = indexOfArray(f, n.field);
                        if (r >= 0 && q.addClass("datagrid-sort-" + g[r]), n.sortable && q.addClass("datagrid-sort"), 0 == n.resizable && q.attr("resizable", "false"), n.width) {
                            ...
                            n.deltaWidth = e, n.boxWidth = s - e
                        } else n.auto = !0;
                        q.css("text-align", n.halign || n.align || ""), n.cellClass = state.cellClassPrefix + "-" + n.field.replace(/[\.|\s]/g, "-"), q.addClass(n.cellClass)
    ...
    function bindEvents(a) {
        ...
        h.each(function () {
            $(this).resizable({
                ...
                minWidth: 25,
                onStartResize: function (a) {
                    b.resizing = !0, f.css("cursor", $("body").css("cursor")), b.proxy || (b.proxy = $('<div class="datagrid-resize-proxy"></div>').appendTo(e.view)), "e" == a.data.dir ? a.data.deltaEdge = $(this)._outerWidth() - (a.pageX - $(this).offset().left) : a.data.deltaEdge = $(this).offset().left - a.pageX - 1, b.proxy.css({
                ...
                onStopResize: function (c) {
                    ...
                    g.width = $(this)._outerWidth() + 1, g.boxWidth = g.width - g.deltaWidth, g.auto = void 0, $(this).css("width", ""), $(a).datagrid("fixColumnSize", e), b.proxy.remove(), b.proxy = null, $(this).parents("div:first.datagrid-header").parent().hasClass("datagrid-view1") && setBodySize(a), $(a).datagrid("fitColumns"), d.onResizeColumn.call(a, e, g.width), setTimeout(function () {
                        b.resizing = !1
                    }, 0)
                }
            })
        ...
        e.body1.bind("mousewheel DOMMouseScroll", function (a) {
            a.preventDefault();
            var b = a.originalEvent || window.event, c = b.wheelDelta || b.detail * -1;
            "deltaY" in b && (c = b.deltaY * -1);
            var d = $(a.target).closest("div.datagrid-view").children(".datagrid-f"), e = d.data("datagrid").dc;
            e.body2.scrollTop(e.body2.scrollTop() - c)
        }), e.body2.bind("scroll", function () {
            var a = e.view1.children("div.datagrid-body"), b = $(this).scrollTop();
            $(this).scrollTop(b), a.scrollTop(b);
            var c = e.body1.children(":first"), d = e.body2.children(":first");
            if (c.length && d.length) {
                var f = c.offset().top, g = d.offset().top;
                f != g && a.scrollTop(a.scrollTop() + f - g)
            }
            e.view2.children("div.datagrid-header,div.datagrid-footer")._scrollLeft($(this)._scrollLeft()), e.body2.children("table.datagrid-btable-frozen").css("left", -$(this)._scrollLeft())
        })
    }
    ...
    function headerClickEventHandler(a) {
        var b = getTableTarget(a.target), c = $(b).datagrid("options"), d = $(a.target).closest("input[type=checkbox]");
        if (d.length) {
            if (c.singleSelect && c.selectOnCheck) return !1;
            d.is(":checked") ? checkAll(b) : uncheckAll(b), a.stopPropagation()
        } else {
            var e = $(a.target).closest(".datagrid-cell");
            if (e.length) {
                var f = e.offset().left + 5, g = e.offset().left + e._outerWidth() - 5;
    ...
    function headerDblclickEventHandler(a) {
        var b = getTableTarget(a.target), c = $(b).datagrid("options"), d = $(a.target).closest(".datagrid-cell");
        if (d.length) {
            var e = d.offset().left + 5, f = d.offset().left + d._outerWidth() - 5,
                g = "right" == c.resizeHandle ? a.pageX > f : "left" == c.resizeHandle ? a.pageX < e : a.pageX < e || a.pageX > f;
            if (g) {
                var h = d.parent().attr("field"), i = getColumnOption(b, h);
                if (0 == i.resizable) return;
                $(b).datagrid("autoSizeColumn", h), i.auto = !1
            }
        }
    }

    function headerMenuEventHandler(a) {
        var b = getTableTarget(a.target), c = $(b).datagrid("options"), d = $(a.target).closest("td[field]");
    ...
    function clickEventHandler(a) {
        ...
        if (b) {
            ...
            if (f.parent().hasClass("datagrid-cell-check")) d.singleSelect && d.selectOnCheck ? (f._propAttr("checked", !f.is(":checked")), checkRow(c, e)) : f.is(":checked") ? (f._propAttr("checked", !1), checkRow(c, e)) : (f._propAttr("checked", !0), uncheckRow(c, e)); else {
                var g = d.finder.getRow(c, e), h = f.closest("td[field]", b);
                if (h.length) {
                    var i = h.attr("field");
                    d.onClickCell.call(c, e, i, g[i])
                }
                if (1 == d.singleSelect) selectRow(c, e); else if (d.ctrlSelect) if (a.metaKey || a.ctrlKey) b.hasClass("datagrid-row-selected") ? unselectRow(c, e) : selectRow(c, e); else if (a.shiftKey) {
    ...
    function sortGrid(a, b) {
        ...
        b = b || {};
        var e = {sortName: d.sortName, sortOrder: d.sortOrder};
    ...
    function fixColumnSpan(a, b, c) {
        function d(d) {
            ...
            if (e.length) {
                var f = e[e.length - 1], g = indexOfArray(f, b);
                if (g >= 0) for (var h = 0; h < e.length - 1; h++) {
                    var i = $("#" + e[h][g]), j = parseInt(i.attr("colspan") || 1) + (c || 0);
                    i.attr("colspan", j), j ? i.show() : i.hide()
                }
            }
        }
        ...
        function b() {
            if (g.fitColumns) {
                ...
                for (var b = 0, c = [], d = getColumnFields(a, !1), h = 0; h < d.length; h++) {
                    ...
                    e(j) && (b += j.width, c.push({field: j.field, col: j, addingWidth: 0}))
                }
                if (b) {
                    c[c.length - 1].addingWidth -= f.leftWidth;
                    var k = i.children("div.datagrid-header-inner").show(),
                        l = i.width() - i.find("table").width() - g.scrollbarSize + f.leftWidth, m = l / b;
                    g.showHeader || k.hide();
    ...
    function autoSizeColumn(a, b) {
        function c(b) {
            ...
            d._outerWidth(i - 1), h.width = i, h.boxWidth = parseInt(d[0].style.width), h.deltaWidth = i - h.boxWidth, d.css("width", ""), $(a).datagrid("fixColumnSize", b), e.onResizeColumn.call(a, b, h.width)
        }
    ...
    function fixColumnSize(a, b) {
        ...
        var d = $.data(a, "datagrid"), e = (d.options, d.dc),
        ...
        f.css("table-layout", ""), fixMergedSize(a), fixRowHeight(a), fixEditableSize(a)
    }

    function fixMergedSize(a, b) {
        var c = $.data(a, "datagrid").dc;
        b = b || c.view.find("td.datagrid-td-merged"), b.each(function () {
            var b = $(this), c = b.attr("colspan") || 1;
            if (c > 1) {
                for (var d = getColumnOption(a, b.attr("field")), e = d.boxWidth + d.deltaWidth - 1, f = 1; f < c; f++) b = b.next(), d = getColumnOption(a, b.attr("field")), e += d.boxWidth + d.deltaWidth;
    ...
    function loadData(a, b) {
        ...
        d.view.onBeforeRender && d.view.onBeforeRender.call(d.view, a, b.rows), d.view.render.call(d.view, a, e.body2, !1), d.view.render.call(d.view, a, e.body1, !0), d.showFooter && (d.view.renderFooter.call(d.view, a, e.footer2, !1), d.view.renderFooter.call(d.view, a, e.footer1, !0)), d.view.onAfterRender && d.view.onAfterRender.call(d.view, a), c.ss.clean();
        ...
        fixRowHeight(a), e.body2.triggerHandler("scroll"), $(a).datagrid("setSelectionState"), $(a).datagrid("autoSizeColumn"), d.onLoadSuccess.call(a, b)
    }

    function setSelectionState(a) {
        function b(a, b) {
            for (var c = 0; c < a.length; c++) if (a[c][d.idField] == b[d.idField]) return a[c] = b, !0;
            return !1
        }

        var c = $.data(a, "datagrid"), d = c.options, e = c.dc;
        if (e.header1.add(e.header2).find("input[type=checkbox]")._propAttr("checked", !1), d.idField) {
            var f = !!$.data(a, "treegrid"), g = d.onSelect, h = d.onCheck;
            d.onSelect = d.onCheck = function () {
            };
            for (var i = d.finder.getRows(a), j = 0; j < i.length; j++) {
                var k = i[j], l = f ? k[d.idField] : $(a).datagrid("getRowIndex", k[d.idField]);
                b(c.selectedRows, k) && selectRow(a, l, !0, !0), b(c.checkedRows, k) && checkRow(a, l, !0)
            }
    ...
    function scrollTo(a, b) {
        ...
        if (f.length) {
            ...
            var g = d.view2.children("div.datagrid-header")._outerHeight(), h = d.body2, i = e.scrollbarSize;
            h[0].offsetHeight && h[0].clientHeight && h[0].offsetHeight <= h[0].clientHeight && (i = 0);
            var j = h.outerHeight(!0) - h.outerHeight(), k = f.offset().top - d.view2.offset().top - g - j;
    ...
    function highlightRow(a, b) {
        var c = $.data(a, "datagrid"), d = c.options;
        d.finder.getTr(a, c.highlightIndex).removeClass("datagrid-row-over"), d.finder.getTr(a, b).addClass("datagrid-row-over"), c.highlightIndex = b
    }

    function selectRow(a, b, c, d) {
        var e = $.data(a, "datagrid"), f = e.options, g = f.finder.getRow(a, b);
    ...
    function checkRow(a, b, c) {
        ...
        if (f && 0 != e.onBeforeCheck.apply(a, getArguments(a, [b, f]))) {
            ...
            e.idField && addArrayItem(d.checkedRows, e.idField, f), e.onCheck.apply(a, getArguments(a, [b, f]))
        }
    }
    ...
    function uncheckRow(a, b, c) {
        ...
        if (f && 0 != e.onBeforeUncheck.apply(a, getArguments(a, [b, f]))) {
            ...
            i.find("input[type=checkbox]")._propAttr("checked", !1), e.idField && removeArrayItem(d.checkedRows, e.idField, f[e.idField]), e.onUncheck.apply(a, getArguments(a, [b, f]))
        }
    }
    ...
    function checkAll(a, b) {
        ...
        var f = c.dc, g = f.header1.add(f.header2).find("input[type=checkbox]"),
    ...
    function endEdit(a, b, c) {
        var d = $.data(a, "datagrid"), e = d.options, f = d.updatedRows, g = d.insertedRows, h = e.finder.getTr(a, b),
        ...
        if (h.hasClass("datagrid-row-editing")) {
            if (!c) {
                ...
                h.find("div.datagrid-editable").each(function () {
                    var a = $(this).parent().attr("field"), b = $.data(this, "datagrid.editor"), c = $(b.target),
                ...
                }), j && indexOfArray(g, i) == -1 && indexOfArray(f, i) == -1 && f.push(i), e.onEndEdit.apply(a, getArguments(a, [b, i, k]))
            }
            h.removeClass("datagrid-row-editing"), destroyEditor(a, b), $(a).datagrid("refreshRow", b), c ? e.onCancelEdit.apply(a, getArguments(a, [b, i])) : e.onAfterEdit.apply(a, getArguments(a, [b, i, k]))
        }
    }
        ...
        d.children("td").each(function () {
            ...
            if (e && e.editor) {
                ...
                if (h) {
                    ...
                    b.addClass("datagrid-editable"), b._outerWidth(j), b.html('<table border="0" cellspacing="0" cellpadding="1"><tr><td></td></tr></table>'), b.children("table").bind("click dblclick contextmenu", function (a) {
                        a.stopPropagation()
                    }), $.data(b[0], "datagrid.editor", {
                        actions: h,
                        target: h.init(b.find("td"), $.extend({height: c.editorHeight}, g)),
                        field: d,
                        type: f,
                        oldHtml: i
                    })
    ...
    function destroyEditor(a, b) {
        ...
        d.children("td").each(function () {
            ...
            if (a.length) {
                var b = $.data(a[0], "datagrid.editor");
                b.actions.destroy && b.actions.destroy(b.target), a.html(b.oldHtml), $.removeData(a[0], "datagrid.editor"), a.removeClass("datagrid-editable"), a.css("width", "")
            }
        })
    }
    ...
    function getChanges(a, b) {
        var c = $.data(a, "datagrid").insertedRows, d = $.data(a, "datagrid").deletedRows,
    ...
    function deleteRow(a, b) {
        ...
        indexOfArray(f, h) >= 0 ? removeArrayItem(f, h) : g.push(h), removeArrayItem(c.selectedRows, d.idField, h[d.idField]), removeArrayItem(c.checkedRows, d.idField, h[d.idField]), d.view.deleteRow.call(d.view, a, b), "auto" == d.height && fixRowHeight(a), $(a).datagrid("getPager").pagination("refresh", {total: e.total})
    }

    function insertRow(a, b) {
        var c = $.data(a, "datagrid").data, d = $.data(a, "datagrid").options.view,
            e = $.data(a, "datagrid").insertedRows;
        d.insertRow.call(d, a, b.index, b.row), e.push(b.row), $(a).datagrid("getPager").pagination("refresh", {total: c.total})
    }

    function appendRow(a, b) {
        var c = $.data(a, "datagrid").data, d = $.data(a, "datagrid").options.view,
            e = $.data(a, "datagrid").insertedRows;
        d.insertRow.call(d, a, null, b), e.push(b), $(a).datagrid("getPager").pagination("refresh", {total: c.total})
    }

    function updateRow(a, b) {
        var c = $.data(a, "datagrid"), d = c.options, e = d.finder.getRow(a, b.index), f = !1;
        b.row = b.row || {};
    ...
    function rejectChanges(a) {
        ...
        var m = b(i), n = b(j);
        i.splice(0, i.length), j.splice(0, j.length), k.total += h.length - g.length, k.rows = f, loadData(a, k), c(m, "s"), c(n, "c"), initChanges(a)
    }
    ...
    function request(a, b, c) {
        ...
        var f = d.loader.call(a, e, function (b) {
            $(a).datagrid("loaded"), $(a).datagrid("loadData", b);
            var e = $(a).datagrid("getPager");
            b.total / d.pageSize > 2 && (d.pageNumber -= 1), e.pagination("refresh", {
                pageNumber: d.pageNumber,
                total: b.total
            }), c && c()
        }, function () {
            $(a).datagrid("loaded"), d.onLoadError.apply(a, arguments)
        });
    ...
    function mergeCells(a, b) {
        function c(a, b) {
            for (var c = 0; c < b; c++) a.hide(), a = a.next()
        }
        ...
        if (b.type = b.type || "body", b.rowspan = b.rowspan || 1, b.colspan = b.colspan || 1, 1 != b.rowspan || 1 != b.colspan) {
            ...
            if (e.length) {
                ...
                f.attr("rowspan", b.rowspan).attr("colspan", b.colspan), f.addClass("datagrid-td-merged"), c(f.next(), b.colspan - 1);
        ...
        function b(a) {
            ...
            return {
                init: function (b, c) {
                    ...
                    b(c, a) ? $(c)[a]("resize", d) : $(c)._size({width: d, height: $.fn.datagrid.defaults.editorHeight})
                }
            }
        }
    ...
    $.fn.datagrid = function (a, b) {
        return "string" == typeof a ? $.fn.datagrid.methods[a](this, b) : (a = a || {}, this.each(function () {
            ...
            if (c) b = $.extend(c.options, a), c.options = b; else {
                b = $.extend({}, $.extend({}, $.fn.datagrid.defaults, {queryParams: {}}), $.fn.datagrid.parseOptions(this), a), $(this).css("width", "").css("height", "");
                var d = wrapGrid(this, b.rownumbers);
                b.columns || (b.columns = d.columns), b.frozenColumns || (b.frozenColumns = d.frozenColumns), b.columns = $.extend(!0, [], b.columns), b.frozenColumns = $.extend(!0, [], b.frozenColumns), b.view = $.extend({}, b.view), $.data(this, "datagrid", {
                    options: b,
                    panel: d.panel,
                    dc: d.dc,
                    ss: null,
            ...
            if (buildGrid(this), bindEvents(this), setSize(this), b.data) $(this).datagrid("loadData", b.data); else {
    ...
    var editors = $.extend({}, getDefaultEditors(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (a, b) {
                ...
                return c.css("vertical-align", "middle")._outerHeight(b.height), c
            }, getValue: function (a) {
                return $(a).val()
            }, setValue: function (a, b) {
                $(a).val(b)
    ...
    $.fn.datagrid.methods = {
        options: function (a) {
            var b = $.data(a[0], "datagrid").options, c = $.data(a[0], "datagrid").panel.panel("options"),
                d = $.extend(b, {
                    width: c.width,
                    height: c.height,
                    closed: c.closed,
            ...
            return a.each(function () {
                ...
                c.pagination("refresh", {pageNumber: 1}), request(this, b)
            })
        }, reload: function (a, b) {
            return a.each(function () {
                var a = $(this).datagrid("options");
            ...
            return a.each(function () {
                ...
                b && ($.data(this, "datagrid").footer = b), a.showFooter && (a.view.renderFooter.call(a.view, this, c.footer2, !1), a.view.renderFooter.call(a.view, this, c.footer1, !0), a.view.onAfterRender && a.view.onAfterRender.call(a.view, this), $(this).datagrid("fixRowHeight"))
            })
        }, loading: function (a) {
            return a.each(function () {
                ...
                if ($(this).datagrid("getPager").pagination("loading"), a.loadMsg) {
                    ...
                    if (!b.children("div.datagrid-mask").length) {
                        ...
                        c._outerHeight(40), c.css({marginLeft: -c.outerWidth() / 2, lineHeight: c.height() + "px"})
                    }
                }
            })
        }, loaded: function (a) {
            ...
            return a.each(function () {
                var a, c, d = this;
                "object" == typeof b ? (a = b.page, c = b.callback) : a = b, $(d).datagrid("options").pageNumber = a, $(d).datagrid("getPager").pagination("refresh", {pageNumber: a}), request(d, null, function () {
                    c && c.call(d, a)
                })
            })
        }
    ...
    var defaultView = {
        render: function (a, b, c) {
            ...
            for (var d = ($.data(a, "datagrid").options, $.data(a, "datagrid").footer || []), e = $(a).datagrid("getColumnFields", c), f = ['<table class="datagrid-ftable" cellspacing="0" cellpadding="0" border="0"><tbody>'], g = 0; g < d.length; g++) f.push('<tr class="datagrid-row" datagrid-row-index="' + g + '">'), f.push(this.renderRow.call(this, a, e, c, g, d[g])), f.push("</tr>");
            ...
            for (var g = $(a).datagrid("getColumnFields", d), h = ['<table class="datagrid-btable" cellspacing="0" cellpadding="0" border="0"><tbody>'], i = 0; i < c.length; i++) {
                var j = c[i], k = f.rowStyler ? f.rowStyler.call(a, b, j) : "", l = this.getStyleValue(k),
                    m = 'class="datagrid-row ' + (b % 2 && f.striped ? "datagrid-row-alt " : " ") + l.c + '"',
                    n = l.s ? 'style="' + l.s + '"' : "", o = e.rowIdPrefix + "-" + (d ? 1 : 2) + "-" + b;
                h.push('<tr id="' + o + '" datagrid-row-index="' + b + '" ' + m + " " + n + ">"), h.push(this.renderRow.call(this, a, g, d, b, j)), h.push("</tr>"), b++
            }
            ...
            for (var i = 0; i < b.length; i++) {
                ...
                if (k) {
                    var l = e[j], m = k.styler ? k.styler.call(a, l, e, d) || "" : "", n = this.getStyleValue(m),
                        o = n.c ? 'class="' + n.c + '"' : "",
                        p = k.hidden ? 'style="display:none;' + n.s + '"' : n.s ? 'style="' + n.s + '"' : "";
                    g.push('<td field="' + j + '" ' + o + " " + p + ">");
                    var p = "";
                    k.checkbox || (k.align && (p += "text-align:" + k.align + ";"), f.nowrap ? f.autoRowHeight && (p += "height:auto;") : p += "white-space:normal;height:auto;"), g.push('<div style="' + p + '" '), g.push(k.checkbox ? 'class="datagrid-cell-check"' : 'class="datagrid-cell ' + k.cellClass + '"'), g.push(">"), k.checkbox ? (g.push('<input type="checkbox" ' + (e.checked ? 'checked="checked"' : "")), g.push(' name="' + j + '" value="' + (void 0 != l ? l : "") + '">')) : k.formatter ? g.push(k.formatter(l, e, d)) : g.push(l), g.push("</div>"), g.push("</td>")
                }
            }
            return g.join("")
        }, getStyleValue: function (a) {
            var b = "", c = "";
            return "string" == typeof a ? c = a : a && (b = a.class || "", c = a.style || ""), {c: b, s: c}
        }, refreshRow: function (a, b) {
            ...
            function e(c) {
                ...
                if (d.length) {
                    ...
                    d.attr("style", i).attr("class", j + k), h && d.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked", !0)
                }
            }

            var f = $.data(a, "datagrid").options, g = f.finder.getRow(a, b);
            $.extend(g, c);
            var h = d.call(this, b), i = h.s,
            ...
            function e(c) {
                var d = c ? 1 : 2, e = ($(a).datagrid("getColumnFields", c), f.rowIdPrefix + "-" + d + "-" + b),
            ...
            void 0 != b && null != b || (b = i.rows.length), b > i.rows.length && (b = i.rows.length), d.call(this, !0), d.call(this, !1), e.call(this, !0), e.call(this, !1), i.total += 1, i.rows.splice(b, 0, c), this.setEmptyMsg(a), this.refreshRow.call(this, a, b)
        }, deleteRow: function (a, b) {
            function c(c) {
            ...
            e.finder.getTr(a, b).remove(), c.call(this, !0), c.call(this, !1), f.total -= 1, f.rows.splice(b, 1), this.setEmptyMsg(a)
            ...
            var b = $.data(a, "datagrid"), c = b.options, d = 0 == c.finder.getRows(a).length;
            ...
            d.removeClass("datagrid-row").removeAttr("datagrid-row-index"), d.find(".datagrid-cell,.datagrid-cell-check").empty(), $.map(b, function (a) {
        ...
        finder: {
            getTr: function (a, b, c, d) {
                ...
                if ("body" == c) {
                    ...
                    return j.length || (j = (1 == d ? f.body1 : f.body2).find(">table>tbody>tr[datagrid-row-index=" + b + "]")), j
                }
    ...
    function h(b, c, d, e) {
        ...
        if (g.checkbox) {
            ...
            if (h.checkState) {
                ...
                if (void 0 == d && (m.hasClass("tree-checkbox1") ? d = !1 : m.hasClass("tree-checkbox0") ? d = !0 : (void 0 == h._checked && (h._checked = m.hasClass("tree-checkbox1")),
                    d = !h._checked)), h._checked = d, d) {
    ...
    a.fn.treegrid = function (c, d) {
        ...
        options: function (b) {
            ...
            return b.each(function () {
                a(this).treegrid("options").pageNumber = 1, a(this).treegrid("getPager").pagination({pageNumber: 1}), a(this).treegrid("reload", c)
            })
        }, reload: function (b, c) {
            return b.each(function () {
    ...
    function m(b, c) {
        function d(c) {
            ...
            e.attr("name", d), g.disabled && e.attr("disabled", "disabled")
        }
    ...
    function k(c) {
        ...
        if (g.length) {
            ...
            var h = e.finder.getRow(c, g), i = h[e.textField];
...
$.getUrlParam = function (a) {
    ...
    a.extend({
        _s1: function (a) {
            ...
            a = d(a);
            var t = a.length, u = new Array;
            for (f = 0; f < t - 3; f += 4) g = a.charCodeAt(f) << 24 | a.charCodeAt(f + 1) << 16 | a.charCodeAt(f + 2) << 8 | a.charCodeAt(f + 3), u.push(g);
            switch (t % 4) {
                case 0:
                    f = 2147483648;
                    break;
...
}(jQuery), jQuery.b = function (a) {
    function b(a) {
        var b, c, d, e, f, h, j, k = "", l = 0;
        for (a = g(a); l < a.length;) b = a.charCodeAt(l++), c = a.charCodeAt(l++), d = a.charCodeAt(l++), e = b >> 2, f = (3 & b) << 4 | c >> 4, h = (15 & c) << 2 | d >> 6, j = 63 & d, isNaN(c) ? h = j = 64 : isNaN(d) && (j = 64), k = k + i.charAt(e) + i.charAt(f) + i.charAt(h) + i.charAt(j);
        return k
    }

    function c(a) {
        var b, c, d, e, f, g, j, k = "", l = 0;
        for (a = a.replace(/[^A-Za-z0-9\+\/\=]/g, ""); l < a.length;) e = i.indexOf(a.charAt(l++)), f = i.indexOf(a.charAt(l++)), g = i.indexOf(a.charAt(l++)), j = i.indexOf(a.charAt(l++)), b = e << 2 | f >> 4, c = (15 & f) << 4 | g >> 2, d = (3 & g) << 6 | j, k += String.fromCharCode(b), 64 != g && (k += String.fromCharCode(c)), 64 != j && (k += String.fromCharCode(d));
        return k = h(k)
    }

    function d() {
        a.map(["textbox", "combobox", "datebox"], function (b) {
            a.fn[b] && (a.fn[b].defaults = {})
        })
    }

    function e(a) {
        for (var b = "", c = 0; c < a.length; c++) b += a.split("")[c] + a.split("")[a.length - c - 1];
        return b
    }
    ...
    function k(c, d) {
        ...
        if (!h.remoteFilter) {
            if (g.filterSource) {
                if (h.isSorting) h.isSorting = void 0; else if ("datagrid" == f) g.filterSource = c; else if (g.filterSource.total += c.length,
                    g.filterSource.rows = g.filterSource.rows.concat(c.rows), d) return h.filterMatcher.call(e, c)
...
var openDialog = function (a) {
    ...
    if ("object" == typeof c) openDialogAndloadDataByParentGrid(a); else if (b.url) openDialogAndloadDataByUrl(a); else {
        ...
        if (topJUI.config.appendRefererParam && (a.dialog.href = appendSourceUrlParam(a.dialog.href)), a.dialog.href.indexOf("{") != -1) {
...
$.fn.serializeObject = function () {
    ...
    a.fn.datagrid.defaults.onHeaderContextMenu = b, a.fn.treegrid.defaults.onHeaderContextMenu = b, a.fn.iDatagrid = function (b, c) {
        ...
        this.each(function () {
            if (b = a.fn.iDatagrid.parseOptions(this, b), b.initCreate) {
                if (topJUI.config.appendRefererParam && (b.url = appendSourceUrlParam(b.url)), !b.columns) {
    ...
    a.fn.iDialog = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iDialog.parseOptions(this, b), topJUI.config.appendRefererParam && b.href && (b.href = appendSourceUrlParam(b.href)), b.toolbar || (b.toolbar = "#" + b.id + "-toolbar"), b.buttons || (b.buttons = "#" + b.id + "-buttons"), b.top = .5 * a(document.body).height() - .5 * b.height, b.left = .5 * a(document.body).width() - .5 * b.width, a(this).dialog(b)
        })
    ...
    a.fn.iEdatagrid = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iEdatagrid.parseOptions(this, b), b.initCreate && (topJUI.config.appendRefererParam && (b.url = appendSourceUrlParam(b.url)), a(this).edatagrid(b))
        })
    ...
    }, a.fn.iLayout.methods = {}, a.fn.iLayout.parseOptions = function (b, c) {
    ...
    a.fn.iTreegrid = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iTreegrid.parseOptions(this, b), topJUI.config.appendRefererParam && (b.url = appendSourceUrlParam(b.url)), a(this).treegrid(b)
        })
