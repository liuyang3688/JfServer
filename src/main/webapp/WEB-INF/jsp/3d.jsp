...
<head>
    ...
    <link rel="stylesheet" href="/glserver/static/css/easyui.css"/>
...
<div class="easyui-dialog" >
    <table id="dd" class="easyui-propertygrid easyui-draggable" style="width: 380px" data-options="
                    url:'/glserver/dev/get_device_info?code=1D53404',
                    method:'get',
                    showGroup:true,
                    scrollbarSize:0,
                    handle:'#dd'
...
<script src="/glserver/static/js/jquery.easyui.min.js"></script>
